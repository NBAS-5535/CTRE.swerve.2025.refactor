...
public final class AprilTagPositions {
    ...
    // Some functions to get AprilTag info for specific structures
    /* Reef */
    public static Pose2d getClosestReefAprilTagPose(CommandSwerveDrivetrain drive) {
    ...
    for (Map.Entry<Integer, Pose2d> entry : aprilTagsToAlignTo.entrySet()) {
      ...
      double distance = RobotPoseUtilityFunctions.findDistanceBetween(currentPose, pose);
